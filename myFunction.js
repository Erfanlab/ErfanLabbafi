function myFunction() {
  ...
  console.log(users);
  checkBox.checked
    ? users.classList.remove("bg-main-500") +
      users.classList.add("bg-gray-800") +
      iconname.classList.remove("bg-black", "text-white") +
      iconname.classList.add("bg-white", "text-black")
    : users.classList.remove("bg-gray-800") +
